import 'package:pubg_admin/Aimbot/db/PostService.dart';
import 'package:pubg_admin/Aimbot/models/post.dart';
import 'package:pubg_admin/Aimbot/screens/home.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:Text("اضف ايمبوت",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize:20),),
        centerTitle: true,
